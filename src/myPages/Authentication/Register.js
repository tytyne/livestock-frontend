                        ...
                        <div className="card">
                            <div className="p-fluid p-formgrid p-grid">
                                <div className="p-field p-col-12 p-md-12">
                                    ...
                                    <InputText id="firstname" type="text" name="email"
                                        value={firstname}
                                        onChange={onChangeFirstname}
                                        validations={[required]} placeholder="FirstName" />
                                </div>
                                <div className="p-field p-col-12 p-md-12">
                                    <label htmlFor="lastname">Lastname</label>
                                    <InputText id="lastname" type="text" name="lastname"
                                        value={lastname}
                                        onChange={onChangeLastname}
                                        validations={[required]} placeholder="LastName" />
                                </div>
                                <div className="p-field p-col-12 p-md-12">
                                    <label htmlFor="username">Username</label>
                                    <InputText id="username" type="input"name="username"
                                        value={username}
                                        onChange={onChangeUsername}
                                        validations={[required]} placeholder="Username" />
                                </div>
                                <div className="p-field p-col-12 p-md-12">
                                ...
                                <div className="p-field p-col-12 p-md-12">
                                    ...
                                    <InputText id="occupation" type="text" name="occupation"
                                        value={occupation}
                                        onChange={onChangeOccupation}
                                        validations={[required]} placeholder="Occupation" />
                                </div>
                                <div className="p-field p-col-12 p-md-12">
